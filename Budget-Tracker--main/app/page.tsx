...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-background">
      ...
      <motion.header 
        className={`fixed top-0 left-0 right-0 z-50 bg-background/0 ${mobileMenuOpen ? 'md:opacity-100 opacity-0' : 'opacity-100'}`}
        style={{ 
          ...
          <div className="flex items-center justify-between py-4 relative">
            ...
            >
              <Link href="/" className="flex items-center gap-2 relative">
                ...
                <motion.span 
                  className="font-bold tracking-tight bg-gradient-to-r from-primary via-violet-500 to-primary bg-clip-text text-transparent drop-shadow-sm animate-gradient-x"
                  whileHover={{ 
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            <motion.div
              className="mobile-menu-panel bg-black dark:bg-zinc-900 border-l shadow-lg"
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              exit={{ x: "100%" }}
            ...
            >
              <div className="py-3 px-4 border-b flex justify-between items-center bg-card shadow-sm sticky top-0 z-10">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-bold text-lg tracking-tight bg-gradient-to-r from-primary via-violet-500 to-primary bg-clip-text text-transparent drop-shadow-sm">Budget Buddy</span>
                </div>
                <motion.button
              ...
              <div className="flex-1 overflow-y-auto py-6 px-5 bg-black dark:bg-zinc-900">
                <h3 className="text-sm uppercase font-medium text-muted-foreground mb-3 ml-1">Navigation</h3>
                <div className="flex flex-col space-y-4">
                  {["Features", "Pricing", "Testimonials", "About", "Contact"].map((item, i) => (
                    <motion.a
                      key={item}
                      href={`#${item.toLowerCase()}`}
                      className="text-foreground hover:text-primary transition-colors duration-200 py-2.5 flex items-center text-base font-medium"
                      onClick={() => setMobileMenuOpen(false)}
                    ...
                    >
                      <motion.div
                        className="w-1.5 h-1.5 rounded-full bg-primary mr-3 opacity-75"
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                ...
                <div className="mt-10 space-y-4">
                  <h3 className="text-sm uppercase font-medium text-muted-foreground mb-3 ml-1">Account</h3>
                  <motion.div
                  ...
                  >
                    ...
                    >
                      <Button 
                        asChild
                        className="w-full justify-center text-base py-5 bg-primary-gradient"
                      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-10">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-bold text-xl tracking-tight bg-gradient-to-r from-primary via-violet-500 to-primary bg-clip-text text-transparent drop-shadow-sm animate-gradient-x">Budget Buddy</span>
              </div>
          ...
          <div className="mt-12 pt-6 border-t border-border/30 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6">
              <p className="text-xs text-muted-foreground">© 2023 Budget Buddy. All rights reserved.</p>
