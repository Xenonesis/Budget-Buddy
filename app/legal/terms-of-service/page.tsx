    ...
    <main className="flex min-h-screen flex-col bg-background overflow-x-hidden">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            By accessing or using Budget Buddy, you agree to be bound by these Terms of Service. If
            you do not agree to these terms, you may not access or use our services.
          </p>

          <h2 className="text-xl font-semibold mt-8 mb-4">2. Description of Service</h2>
          <p>
            Budget Buddy provides financial management tools to help users track expenses, create
            budgets, and gain insights into their spending habits. We may update, modify, or enhance
          ...
          <p>
            ...
            text, graphics, logos, icons, and software, are owned by Budget Buddy or its licensors
          ...
          <p>
            ...
            responsible for the content or practices of these third parties. Your interactions with
            any third-party website or service are solely between you and that third party.
          </p>
          ...
          <p>
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL BUDGET BUDDY BE LIABLE FOR ANY
          ...
          <p>
            We may revise these Terms of Service at any time by posting an updated version. Your
