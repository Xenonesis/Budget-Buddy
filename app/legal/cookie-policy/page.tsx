    ...
    <main className="flex min-h-screen flex-col bg-background overflow-x-hidden">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>Budget Buddy uses cookies for several purposes, including:</p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              <strong>Essential cookies:</strong> These cookies are necessary for the website to
              function properly and cannot be turned off in our systems.
            </li>
            <li>
              <strong>Analytical/performance cookies:</strong> These cookies allow us to recognize
              and count the number of visitors and see how visitors move around our website. This
          ...
          <p>
            Session cookies are temporary cookies that are erased when you close your browser. We
            use session cookies to enable certain site functionality, such as maintaining your login
            session.
          </p>

          <h3 className="text-lg font-medium mt-6 mb-3">2. Persistent Cookies</h3>
          <p>
            Persistent cookies remain on your device for a set period or until you delete them. We
            use persistent cookies to remember your preferences and settings when you visit our site
            again.
          </p>

          <h3 className="text-lg font-medium mt-6 mb-3">3. First-Party Cookies</h3>
          <p>First-party cookies are set by Budget Buddy directly when you use our website.</p>

          <h3 className="text-lg font-medium mt-6 mb-3">4. Third-Party Cookies</h3>
          <p>
            Third-party cookies are set by third-party services that appear on our pages, such as
            analytics services or advertising networks.
          </p>
