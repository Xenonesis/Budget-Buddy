...
const FAQItem = ({ question, answer }: { question: string; answer: string }) => {
  ...
  return (
    <div className="border border-border/50 rounded-lg overflow-hidden hover:border-primary/30 transition-all duration-200">
      <button
      ...
      >
        ...
        <ChevronDown
          className={`w-4 h-4 text-muted-foreground group-hover:text-primary transition-all duration-200 ${isOpen ? 'rotate-180' : ''}`}
        />
      </button>
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="p-4 pt-0 text-muted-foreground leading-relaxed bg-card">{answer}</div>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
...
export default function AboutPage() {
  ...
  // State for FAQ open states
  const [openStates, setOpenStates] = React.useState<Record<number, boolean>>({});

  // State for second FAQ section
  const [faqOpenStates, setFaqOpenStates] = React.useState<Record<number, boolean>>({ 0: true });
    ...
    <div className="animate-fade-in">
        ...
        <div className="container max-w-5xl px-4 py-6 md:px-6 md:py-6 lg:px-8 lg:py-8 relative z-10">
          <div className="relative">
            ...
            <p className="text-muted-foreground max-w-2xl text-lg relative z-10 sm:text-xl">
              Your personal finance companion for smarter decisions and financial freedom
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container max-w-5xl px-4">
            ...
            <Card className="h-full overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-primary/10">
              ...
              <CardContent className="space-y-4 p-6">
                <p className="leading-relaxed text-foreground/90">
                  Budget Buddy revolutionizes personal finance management by combining cutting-edge
                  AI technology with intuitive design. Our platform integrates 20+ AI providers
                  including Google Gemini to deliver personalized financial insights, voice-powered
                  transaction input, and intelligent spending analysis that adapts to your unique
                  financial patterns.
                </p>
                <p className="leading-relaxed text-foreground/90">
                  Built on modern web technologies including Next.js 15, React 19, and Supabase,
                  Budget Buddy offers real-time data synchronization, drag-and-drop budget
                  management, and comprehensive analytics with interactive visualizations. Our voice
                  interface and AI-powered insights make financial management as simple as having a
                  conversation with your personal finance assistant.
                </p>
                <p className="leading-relaxed text-foreground/90">
                  We believe financial empowerment should be accessible to everyone. That&apos;s why
                  we&apos;ve created a platform that not only tracks your finances but actively
                  helps you make smarter decisions through predictive analytics, automated
                  categorization, and export capabilities for Excel and PDF reports.
                </p>
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Send cryptocurrency without worrying about gas fees. Nitrolite enables seamless
                    blockchain interactions by sponsoring transaction costs, making crypto
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Advanced blockchain features integrated directly into your financial management
                    workflow.
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-semibold text-primary mb-1">
                      Open Source Blockchain Integration
                    </h4>
                    <p className="text-sm text-muted-foreground">
                      Explore the Nitrolite integration on GitHub for technical details and
                  ...
                  >
                    <Link
                      href="https://github.com/Xenonesis/Buddy-buddy-crypto"
                      target="_blank"
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2.5 text-sm">
                      <li className="flex items-start gap-2 group">
                        ...
                        <span className="group-hover:translate-x-0.5 transition-transform">
                          Advanced AI integration with 20+ providers for comprehensive financial
                          insights
                        </span>
                      </li>
                      <li className="flex items-start gap-2 group">
                      ...
                      <li className="flex items-start gap-2 group">
                        ...
                        <span className="group-hover:translate-x-0.5 transition-transform">
                          Expanded support for 25+ international currencies
                        </span>
                      </li>
                      <li className="flex items-start gap-2 group">
                        <span className="text-primary group-hover:scale-110 transition-transform">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2.5 text-sm">
                      <li className="flex items-start gap-2 group">
                        ...
                        <span className="group-hover:translate-x-0.5 transition-transform">
                          35% reduction in bundle size with improved code splitting
                        </span>
                      </li>
                      <li className="flex items-start gap-2 group">
                        <span className="text-primary group-hover:scale-110 transition-transform">
                      ...
                      <li className="flex items-start gap-2 group">
                        ...
                        <span className="group-hover:translate-x-0.5 transition-transform">
                          Streaming server components for improved UX
                        </span>
                      </li>
                    </ul>
                  </div>
                ...
                {[
                  {
                    ...
                    answer:
                      'Yes! Budget Buddy offers a comprehensive free tier with all core features including transaction tracking, budgeting, and basic AI insights. Premium features like advanced AI analytics and unlimited voice commands are available in our paid plans.',
                  },
                  {
                    question: 'How secure is my financial data?',
                    answer:
                      'We use bank-level encryption (AES-256) and follow strict security protocols. Your data is encrypted both in transit and at rest. We never store your banking credentials, and you can delete your account and data at any time.',
                  },
                  {
                    question: 'Which AI providers does Budget Buddy support?',
                    answer:
                      'We support 20+ AI providers including OpenAI (GPT-4), Google Gemini, Anthropic Claude, Cohere, Mistral, and many more. The system automatically selects the best provider based on your query and available API keys.',
                  },
                  {
                    question: 'Can I use Budget Buddy on my mobile device?',
                    answer:
                      'Absolutely! Budget Buddy is built mobile-first and works perfectly on all devices. We also offer progressive web app (PWA) capabilities, so you can install it like a native app on your phone.',
                  },
                  {
                    question: 'How does the voice interface work?',
                    answer:
                      'Our voice interface uses advanced speech recognition to let you add transactions, ask questions, and get insights using natural language. Just click the microphone icon and speak normally - no special commands needed!',
                  },
                  {
                    question: 'Can I export my data?',
                    answer:
                      'Yes! You can export your transactions, budgets, and reports in multiple formats including Excel (.xlsx), PDF, and CSV. This ensures you always have access to your financial data.',
                  },
                  {
                    question: 'Do you support multiple currencies?',
                    answer:
                      'Budget Buddy supports 25+ international currencies with real-time exchange rates. You can track expenses in different currencies and view consolidated reports in your preferred currency.',
                  },
                  {
                    question: 'How often is my data synced?',
                    answer:
                      'All changes are synced in real-time across all your devices. When you add a transaction on your phone, it immediately appears on your desktop and vice versa.',
                  },
                  {
                    question: 'Can I set up recurring transactions?',
                    answer:
                      'Yes! You can easily set up recurring transactions for subscriptions, bills, and regular income. The system will automatically add these transactions based on your specified schedule.',
                  },
                  {
                    question: 'What makes Budget Buddy different from other budgeting apps?',
                    answer:
                      'Budget Buddy uniquely combines AI-powered insights, voice interface, real-time sync, and support for multiple AI providers. We focus on making financial management conversational and intelligent, not just transactional.',
                  },
                ].map((item, index) => (
                  ...
                  <div key={index} className="group">
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        <div className={`text-3xl font-bold ${stat.textColor}`}>{stat.number}</div>
                    ...
                    <ul className="space-y-4">
                      <li className="relative pl-7 group">
                        ...
                        <div className="flex justify-between mb-1.5">
                          ...
                          <Badge variant="outline" className="text-xs h-5 bg-primary/5">Aug 2025 - Present</Badge>
                        </div>
                      ...
                      <li className="relative pl-7 group">
                        ...
                        <div className="flex justify-between mb-1.5">
                          ...
                          <Badge variant="outline" className="text-xs h-5 bg-primary/5">Jun 2025 - Present</Badge>
                        </div>
                      ...
                      <li className="relative pl-7 group">
                        ...
                        <div className="flex justify-between mb-1.5">
                          ...
                          <Badge variant="outline" className="text-xs h-5 bg-primary/5">Oct 2025 - Present</Badge>
                        </div>
                  ...
                  {[
                    {
                      question: 'Is Budget Buddy free to use?',
                      answer:
                        "Yes, Budget Buddy's core features are completely free to use. We do offer a premium tier with advanced features like AI-powered insights, unlimited budget categories, and priority support.",
                    },
                    {
                      question: 'How secure is my financial data?',
                      answer:
                        'Budget Buddy uses end-to-end encryption and follows industry-standard security protocols. Your data is stored securely and is never shared with third parties without your explicit permission. We implement bank-level security measures to protect all your sensitive financial information.',
                    },
                    {
                      question: 'Can I import transactions from my bank?',
                      answer:
                        "Yes, Budget Buddy supports CSV imports from most major banks. We're also working on direct bank integrations for seamless transaction syncing, which will be available in our next major update.",
                    },
                    {
                      question: 'Is Budget Buddy available on mobile devices?',
                      answer:
                        'Budget Buddy is fully responsive and works on all devices. We also have dedicated iOS and Android apps available for download, providing a native mobile experience with features like fingerprint authentication and offline access to your budget.',
                    },
                    {
                      question: 'How do I create custom budget categories?',
                      answer:
                        'Navigate to Settings > Categories to create, edit, or delete custom budget categories. You can also set category icons and colors to personalize your experience and make your budget visually intuitive.',
                    },
                    {
                      question: 'Can I share my budget with others?',
                      answer:
                        'Yes, Budget Buddy supports shared budgets for families or couples. Go to Settings > Sharing to invite others to view or collaborate on your budget. You can control permissions at a granular level, allowing view-only or edit access as needed.',
                    },
                  ].map((faq, index) => {
                      ...
                      {[
                        {
                          ...
                          desc: 'React framework v15.5.0',
                        },
                        { name: 'React', logo: '/tech/react.svg', desc: 'UI library v19.1.1' },
                        {
                          name: 'TypeScript',
                          logo: '/tech/typescript.svg',
                          desc: 'Type-safe JavaScript v5.9.2',
                        },
                        {
                          name: 'Tailwind CSS',
                          logo: '/tech/tailwind.svg',
                          desc: 'Utility-first CSS v4.1.12',
                        },
                        {
                          name: 'Framer Motion',
                          logo: '/tech/framer.svg',
                          desc: 'Animation library v12.23.12',
                        },
                        {
                          name: 'Radix UI',
                          logo: '/tech/shadcn.png',
                          desc: 'Headless UI components',
                        },
                        {
                          name: 'Lucide React',
                          logo: '/tech/react.svg',
                          desc: 'Icon library v0.540.0',
                        },
                      ].map((tech, i) => (
                        <div
                          key={i}
                        ...
                        >
                          ...
                          <h4 className="text-xs font-medium text-center group-hover:text-primary transition-colors">
                            {tech.name}
                          </h4>
                      ...
                      {[
                        {
                          ...
                          desc: 'Backend-as-a-Service v2.55.0',
                        },
                        {
                          name: 'PostgreSQL',
                          logo: '/tech/postgres.svg',
                        ...
                        { name: 'Node.js', logo: '/tech/nodejs.svg', desc: 'JavaScript runtime' },
                        {
                          ...
                          desc: 'Generative AI v0.24.1',
                        },
                        {
                          name: 'Zustand',
                          logo: '/tech/react.svg',
                          desc: 'State management v5.0.8',
                        },
                      ].map((tech, i) => (
                        <div
                          key={i}
            ...
            <Card className="mb-10 sm:mb-12 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border-0 bg-gradient-to-br from-white via-white to-primary/5 dark:from-gray-950 dark:via-gray-950 dark:to-primary/5">
              <CardHeader className="bg-gradient-to-r from-primary/15 via-violet-400/10 to-primary/15 border-b border-primary/20 p-8 relative overflow-hidden">
                ...
                <CardDescription className="text-lg text-muted-foreground relative z-10 mt-2">
                  See how Budget Buddy&apos;s cutting-edge features stack up against traditional
                  budget managers
                </CardDescription>
              </CardHeader>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm leading-relaxed text-muted-foreground">
                            Budget Buddy revolutionizes financial management with{' '}
                            <span className="font-semibold text-primary">20+ AI providers</span>,
                            ...
                            , and
                            <span className="font-semibold text-primary"> real-time data sync</span>
                            . Built on Next.js 15 and React 19, it offers capabilities that
                            traditional budget apps simply can&apos;t match.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative bg-gradient-to-br from-primary/8 via-violet-500/5 to-primary/8 p-8 rounded-3xl border border-primary/20 backdrop-blur-sm">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
                          Experience the future of financial management with cutting-edge technology
                          and innovative features that simply can&apos;t match.
                        </p>
                      </div>
                          ...
                          <div className="relative bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl border border-primary/20 backdrop-blur-sm group-hover:border-primary/30 transition-all">
                            <div className="flex items-start gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                  Revolutionary voice commands for transaction input and financial
                                  queries
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="relative bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl border border-primary/20 backdrop-blur-sm group-hover:border-primary/30 transition-all">
                            <div className="flex items-start gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                  Unmatched AI integration with Google Gemini, OpenAI, and 18+ other
                                  models
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="relative bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl border border-primary/20 backdrop-blur-sm group-hover:border-primary/30 transition-all">
                            <div className="flex items-start gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                  Built on Next.js 15, React 19, and cutting-edge web technologies
                                </p>
                              </div>
                            </div>
                          </div>
        ...
        <AnimateInView className="text-center mb-6 sm:mb-8">
          <Link
            href="/dashboard"
            className="inline-flex items-center text-sm font-medium text-primary hover:underline hover:text-primary/80 transition-colors py-2 px-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
